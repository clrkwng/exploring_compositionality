...
class WangNet(nn.Module):
	def __init__(self, boolvec_dim, emb_dims, num_cont, lin_layer_sizes, output_size, hidden_drop_p, batch_flag):
		...
		self.scale_cont_layers = nn.ModuleList([LBDLayer(num_cont, 8, batch_flag, 0), LBDLayer(8, 32, batch_flag, 0), LBDLayer(32, 64, batch_flag, 0), \
																						LBDLayer(64, self.embed_dim * boolvec_dim, batch_flag, 0)])
