...
This model is used to count the number of objects in the scene.
"""
...
class LightningCLEVRClassifier(pl.LightningModule):
  ...
  def training_step(self, train_batch, batch_idx):
    ...
    self.train_cube_correct += single_label_get_num_correct(cube_preds, cube_labels)
    self.train_cylinder_correct += single_label_get_num_correct(cylinder_preds, cylinder_labels)
    self.train_sphere_correct += single_label_get_num_correct(sphere_preds, sphere_labels)
  ...
  def validation_step(self, val_batch, batch_idx):
    with self.logger.experiment.validate():
      ...
      self.val_cube_correct += single_label_get_num_correct(cube_preds, cube_labels)
      self.val_cylinder_correct += single_label_get_num_correct(cylinder_preds, cylinder_labels)
      self.val_sphere_correct += single_label_get_num_correct(sphere_preds, sphere_labels)
